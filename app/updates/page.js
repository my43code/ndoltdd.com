  ...
  return (
    <main className="bg-[#f4f5ef]">
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-20 lg:px-6">
        <section className="mb-10 overflow-hidden rounded-[1.5rem] border border-slate-200/80 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-5 text-white shadow-[0_30px_70px_-35px_rgba(15,23,42,0.5)] sm:rounded-[2.25rem] sm:p-6 md:p-8 lg:p-10">
